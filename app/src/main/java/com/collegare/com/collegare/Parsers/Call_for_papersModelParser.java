...
class Call_for_papersModelParser {
		...
		public Call_for_papersModel parseCall_for_papersModel(String json_object) {
			...
			try {
					...
					local_model = new Call_for_papersModel(jsobj.getString("end_date") , jsobj.getString("privacy") , jsobj.getString("announcement") , jsobj.getString("start_date") , jsobj.getString("timezone") , );
 			} 
